...
$pdf->Image($imgBG, 0, 0, 8.5, 8.5);
centerImage($photo_couple, $pdf);
$file_name = '/pdf/in-a-wedding-'.$bookID.'.pdf';
$upload_dir = wp_upload_dir();
$absolute_path = $upload_dir['basedir'];
$pdf_save = $pdf;
$pdf_save->Output('F',$absolute_path.$file_name);
update_post_meta($bookID,'book_pdf',$upload_dir['baseurl'].$file_name);
$pdf->Output('i');
?>